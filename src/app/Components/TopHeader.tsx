  ...
  return (
    <main>
        ...
        <div className='flex items-center'>
          <p className='text-white flex items-center pl-[300px] font-normal  text-[13px] leading-[14.3px]'> <Check className="w-[16px] h-[16px]"/>Free shipping on all orders over $50</p>
        </div>
